...
class WoTReplayParser {
    ...
    {
        $versionString = "wot-replay-parser (" . self::VERSION . ") by the silvervest group (http://www.silvervest.net)";
            ...
            while ($currentBlockIndex <= $blockCount) {
                try {
                    ...
                    if ($decodedBlockData === null) {
                        ...
                        $decodedBlockData = phpickle::loads($blockData);
                    ...
                    if (($personalInfo = $this->array_get_key_recursive("personal", $decodedBlockData)) !== false) {
                        ...
                        $personalInfo["achievements"] = $this->getAchievements($personalInfo["achievements"]);
